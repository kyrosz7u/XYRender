...
public:
    ...
    void registerOnKeyFunc(onKeyPressFunc func) { m_keypress_events.push_back(func); }
    void registerOnCharFunc(onKeyCharFunc func) { m_keychar_events.push_back(func); }
    void registerOnCursorPosFunc(onCursorPosFunc func) { m_cursor_pos_events.push_back(func); }
    void registerOnCursorEnterFunc(onCursorEnterFunc func) { m_cursor_enter_events.push_back(func); }
    void registerOnWindowSizeFunc(onWindowSizeFunc func) { m_window_size_events.push_back(func); }
    void registerOnWindowCloseFunc(onWindowCloseFunc func) { m_window_close_events.push_back(func); }
