...
#ifndef XEXAMPLE_MATH_VECTOR3_H
#define XEXAMPLE_MATH_VECTOR3_H
    ...
    public:
        ...
        */
        ...
        float angleBetween(const Vector3& dest) const
        {
            ...
            f = std::clamp(f, (float)-1.0, (float)1.0);
            return std::acos(f);
        }
        ...
        */
        ...
        static float getMaxElement(const Vector3& v) { return std::max({v.x, v.y, v.z}); }
