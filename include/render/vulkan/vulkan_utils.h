...
#define VULKANRENDER_VULKAN_UTILS_S
...
namespace VulkanRender
{
    ...
    public:
        ...
        static VkImageView    createImageView(VkDevice           device,
                                              ...
                                              uint32_t           miplevels);
        static void           transitionImageLayout(class VulkanContext* context,
                                                    VkImage               image,
        ...
        static void           copyBufferToImage(class VulkanContext* context,
                                                VkBuffer              buffer,
                                                VkImage               image,
                                                uint32_t              width,
                                                uint32_t              height,
                                                uint32_t              layer_count);
        static void           genMipmappedImage(class VulkanContext* context,
                                                VkImage               image,
                                                uint32_t              width,
                                                uint32_t              height,
                                                uint32_t              mip_levels);
