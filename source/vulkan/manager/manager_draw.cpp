...
uint32_t VulkanManager::m_max_vertex_blending_mesh_count = 256;
uint32_t VulkanManager::m_max_material_count             = 256;
...
void VulkanManager::renderFrameForward(class Scene&                scene,
