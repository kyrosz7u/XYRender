...
void MainCameraForwardRenderPass::initialize(RenderPassInitInfo *renderpass_init_info)
{
    auto main_camera_renderpass_init_info = static_cast<MainCameraForwardRenderPassInitInfo *>(renderpass_init_info);
...
void MainCameraForwardRenderPass::setupRenderPass()
{
...
void MainCameraForwardRenderPass::setupFrameBuffer()
{
...
void MainCameraForwardRenderPass::setupSubpass()
{
...
void MainCameraForwardRenderPass::updateAfterSwapchainRecreate()
{
