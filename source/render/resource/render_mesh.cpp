...
void RenderMesh::ToGPU()
{
    ...
    memcpy(buffer_ptr + vertex_position_offset, m_positions.data(), (size_t) vertex_position_buffer_size);
    memcpy(buffer_ptr + vertex_normal_offset, m_normals.data(), (size_t) vertex_normal_buffer_size);
    memcpy(buffer_ptr + vertex_texcoord_offset, m_texcoords.data(), (size_t) vertex_texcoord_buffer_size);
    memcpy(buffer_ptr + index_offset, m_indices.data(), (size_t) index_buffer_size);
